...
kla_image = face_recognition.load_image_file("kla.jpg")
kla_face_encoding = face_recognition.face_encodings(kla_image)[0]

joji_image = face_recognition.load_image_file("joji.jpg")
joji_face_encoding = face_recognition.face_encodings(joji_image)[0]
